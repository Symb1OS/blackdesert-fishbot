...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        label27.setToolTipText("Максимальное количество итераций для определения статуса подсечки.");
        ...
        label28.setToolTipText("Максимальное количество итераций для определения статуска капчи. (выполнение может занимать продолжительное время на слабых ПК)");
        ...
        label40.setText("x:");
        label40.setToolTipText("Координата верхнего-левого слота инвентаря по осе абсцисс.");
        ...
        label41.setText("dy:");
        label41.setToolTipText("Смещение по y.");
        ...
        label42.setText("dx:");
        label42.setToolTipText("Смещение по x.");
        ...
        label43.setText("y:");
        label43.setToolTipText("Координата верхнего-левого слота инвентаря по осе ординат.");
        ...
        label46.setToolTipText("Если бот не успевает вводить длинные капчи можно немного уменьшить значение, чтобы ускорить ввод. Желательно не ставить очень низкие(нечеловеческие) значения");
        ...
        label49.setToolTipText("<html> Количество итераций для очистки капчи от шума. Чем выше параметр, тем позже бот начнет ввод капчи. <br> Если слабый процессор и бот полностью не успевает вводить капчу можно немного понизить данный параметр. </html>");
        ...
        label112.setToolTipText("Задержка перед задачей на старт.");
        ...
        label113.setToolTipText("Задержка после задачи на старт.");
        ...
        label114.setToolTipText("Задержка перед задачей по проверке готовы ли мы подсекать рыбу.");
        ...
        label115.setToolTipText("Задержка после задачи по проверке готовы ли мы подсекать рыбу.");
        ...
        label116.setToolTipText("Задержка перед подсечкой.");
        ...
        label117.setToolTipText("Задержка после подсечки.");
        ...
        label118.setToolTipText("Задержка перед определением статуса подсечки.");
        ...
        label119.setToolTipText("Задержка после определения статуса подсечки.");
        ...
        label120.setToolTipText("Задержка перед парсингом капчи.");
        ...
        label121.setToolTipText("Задержка после парсинга и ввода капчи.");
        ...
        label122.setToolTipText("Задержка перед определением статуса капчи.");
        ...
        label123.setToolTipText("Задержка после определения статуса капчи.");
        ...
        label124.setToolTipText("Задержка перед запуском задачи по фильтрации лута.");
        ...
        label125.setToolTipText("Задержка после фильтрации лута.");
