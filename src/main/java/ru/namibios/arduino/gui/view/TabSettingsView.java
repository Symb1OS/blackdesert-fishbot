...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(label18, ResourceBundle.getBundle("locale").getString("preference.label.timer"));
        timer.add(label18, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        timerContent.add(label20, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        mode.add(label21, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label22, ResourceBundle.getBundle("locale").getString("preference.language"));
        language.add(label22, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label23, ResourceBundle.getBundle("locale").getString("preference.label.theme"));
        theme.add(label23, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label24, ResourceBundle.getBundle("locale").getString("preference.label.overflow"));
        overflow.add(label24, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label25, ResourceBundle.getBundle("locale").getString("preference.label.state.general"));
        overflowContent.add(label25, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(100, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label26, ResourceBundle.getBundle("locale").getString("preference.label.state.status_cut"));
        label26.setToolTipText("Максимальное количество итераций для определения статуса подсечки.");
        overflowContent.add(label26, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(100, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label27, ResourceBundle.getBundle("locale").getString("preference.label.state.status_captcha"));
        label27.setToolTipText("Максимальное количество итераций для определения статуска капчи. (выполнение может занимать продолжительное время на слабых ПК)");
        overflowContent.add(label27, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label28, ResourceBundle.getBundle("locale").getString("preference.label.loot"));
        lootTouch.add(label28, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label29, ResourceBundle.getBundle("locale").getString("preference.label.loot.slot1"));
        label29.setToolTipText("Координата 1 ячейки лута.");
        lootTouchContent.add(label29, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(100, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label30, ResourceBundle.getBundle("locale").getString("preference.label.loot.slot2"));
        label30.setToolTipText("Координата 2 ячейки лута.");
        lootTouchContent.add(label30, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(100, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label31, ResourceBundle.getBundle("locale").getString("preference.label.loot.slot3"));
        label31.setToolTipText("Координата 3 ячейки лута.");
        lootTouchContent.add(label31, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label32.setText("x:");
        lootTouchContent.add(label32, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label33 = new JLabel();
        label33.setText("x:");
        lootTouchContent.add(label33, new GridConstraints(1, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label34 = new JLabel();
        label34.setText("x:");
        lootTouchContent.add(label34, new GridConstraints(2, 1, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label35 = new JLabel();
        label35.setText("y:");
        lootTouchContent.add(label35, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label36 = new JLabel();
        label36.setText("y:");
        lootTouchContent.add(label36, new GridConstraints(1, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label37 = new JLabel();
        label37.setText("y:");
        lootTouchContent.add(label37, new GridConstraints(2, 3, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        rodTouch = new JPanel();
        ...
        this.$$$loadLabelText$$$(label38, ResourceBundle.getBundle("locale").getString("preference.label.rod"));
        rodTouch.add(label38, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        label39.setText("x:");
        label39.setToolTipText("Координата верхнего-левого слота инвентаря по осе абсцисс.");
        rodTouchContent.add(label39, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label40 = new JLabel();
        label40.setText("dy:");
        label40.setToolTipText("Смещение по y.");
        rodTouchContent.add(label40, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label41 = new JLabel();
        label41.setText("dx:");
        label41.setToolTipText("Смещение по x.");
        rodTouchContent.add(label41, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label42 = new JLabel();
        label42.setText("y:");
        label42.setToolTipText("Координата верхнего-левого слота инвентаря по осе ординат.");
        rodTouchContent.add(label42, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label43, ResourceBundle.getBundle("locale").getString("preference.label.states"));
        state.add(label43, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label44, ResourceBundle.getBundle("locale").getString("preference.label.input"));
        input.add(label44, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label45, ResourceBundle.getBundle("locale").getString("preference.label.delay"));
        label45.setToolTipText("Если бот не успевает вводить длинные капчи можно немного уменьшить значение, чтобы ускорить ввод. Желательно не ставить очень низкие(нечеловеческие) значения");
        inputcontent.add(label45, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label46, ResourceBundle.getBundle("locale").getString("preference.label.parsing"));
        parsing.add(label46, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label47, ResourceBundle.getBundle("locale").getString("preference.label.parse.coef"));
        parsingContent.add(label47, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label48, ResourceBundle.getBundle("locale").getString("preference.label.noise.iteration"));
        label48.setToolTipText("<html> Количество итераций для очистки капчи от шума. Чем выше параметр, тем позже бот начнет ввод капчи. <br> Если слабый процессор и бот полностью не успевает вводить капчу можно немного понизить данный параметр. </html>");
        parsingContent.add(label48, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label49, ResourceBundle.getBundle("locale").getString("preference.label.space"));
        space.add(label49, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label50.setText("x:");
        spaceContent.add(label50, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label51, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        spaceContent.add(label51, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label52, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label54, ResourceBundle.getBundle("locale").getString("preference.label.line"));
        line.add(label54, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label55.setText("x:");
        lineContent.add(label55, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label56, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        lineContent.add(label56, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label57, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label59, ResourceBundle.getBundle("locale").getString("preference.label.subline"));
        subLine.add(label59, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label60.setText("x:");
        subLineContent.add(label60, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label61, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        subLineContent.add(label61, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label62, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label64, ResourceBundle.getBundle("locale").getString("preference.label.state.status_cut"));
        statusCut.add(label64, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label65.setText("x:");
        statusCutContent.add(label65, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label66, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        statusCutContent.add(label66, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label67, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label69, ResourceBundle.getBundle("locale").getString("preference.label.captcha"));
        captcha.add(label69, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label70.setText("x:");
        captchaContent.add(label70, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label71, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        captchaContent.add(label71, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label74, ResourceBundle.getBundle("locale").getString("preference.label.state.status_captcha"));
        statusCaptcha.add(label74, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label75.setText("x:");
        statusCaptchaContent.add(label75, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label76, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        statusCaptchaContent.add(label76, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label77, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label79, ResourceBundle.getBundle("locale").getString("preference.label.loot1"));
        lootOne.add(label79, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label80.setText("x:");
        lootOneContent.add(label80, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label81, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        lootOneContent.add(label81, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label82, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label84, ResourceBundle.getBundle("locale").getString("preference.label.loot2"));
        lootTwo.add(label84, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label85.setText("x:");
        lootTwoContent.add(label85, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label86, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        lootTwoContent.add(label86, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label87, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label89, ResourceBundle.getBundle("locale").getString("preference.label.loot3"));
        lootThree.add(label89, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label90.setText("x:");
        lootThreeContent.add(label90, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label91, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        lootThreeContent.add(label91, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label92, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label94, ResourceBundle.getBundle("locale").getString("preference.label.chat"));
        chat.add(label94, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label95.setText("x:");
        chatContent.add(label95, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label96, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        chatContent.add(label96, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        label97.setText("y:");
        chatContent.add(label97, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        chatContent.add(label98, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label99, ResourceBundle.getBundle("locale").getString("preference.label.fullscreen"));
        fullscreen.add(label99, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(125, -1), null, 0, false));
        ...
        label100.setText("x:");
        fullscreenContent.add(label100, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label101, ResourceBundle.getBundle("locale").getString("preference.label.height"));
        fullscreenContent.add(label101, new GridConstraints(1, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label102, ResourceBundle.getBundle("locale").getString("preference.label.width"));
        ...
        this.$$$loadLabelText$$$(label104, ResourceBundle.getBundle("locale").getString("preference.label.start"));
        delayContent.add(label104, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        final JLabel label105 = new JLabel();
        this.$$$loadLabelText$$$(label105, ResourceBundle.getBundle("locale").getString("preference.label.waitfish"));
        delayContent.add(label105, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        final JLabel label106 = new JLabel();
        this.$$$loadLabelText$$$(label106, ResourceBundle.getBundle("locale").getString("preference.label.cut"));
        delayContent.add(label106, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        final JLabel label107 = new JLabel();
        this.$$$loadLabelText$$$(label107, ResourceBundle.getBundle("locale").getString("preference.label.state.status_cut"));
        delayContent.add(label107, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        final JLabel label108 = new JLabel();
        this.$$$loadLabelText$$$(label108, ResourceBundle.getBundle("locale").getString("preference.label.captcha"));
        delayContent.add(label108, new GridConstraints(4, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        final JLabel label109 = new JLabel();
        this.$$$loadLabelText$$$(label109, ResourceBundle.getBundle("locale").getString("preference.label.state.status_captcha"));
        delayContent.add(label109, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        final JLabel label110 = new JLabel();
        this.$$$loadLabelText$$$(label110, ResourceBundle.getBundle("locale").getString("preference.label.lootfilter"));
        delayContent.add(label110, new GridConstraints(6, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(110, -1), null, 0, false));
        ...
        this.$$$loadLabelText$$$(label111, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label111.setToolTipText("Задержка перед задачей на старт.");
        delayStart.add(label111, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label112, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label112.setToolTipText("Задержка после задачи на старт.");
        delayStart.add(label112, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label113, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label113.setToolTipText("Задержка перед задачей по проверке готовы ли мы подсекать рыбу.");
        delayWaitFish.add(label113, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label114, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label114.setToolTipText("Задержка после задачи по проверке готовы ли мы подсекать рыбу.");
        delayWaitFish.add(label114, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        delayCut = new JPanel();
        ...
        this.$$$loadLabelText$$$(label115, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label115.setToolTipText("Задержка перед подсечкой.");
        delayCut.add(label115, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label116, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label116.setToolTipText("Задержка после подсечки.");
        delayCut.add(label116, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label117, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label117.setToolTipText("Задержка перед определением статуса подсечки.");
        delayStatusCut.add(label117, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label118 = new JLabel();
        this.$$$loadLabelText$$$(label118, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label118.setToolTipText("Задержка после определения статуса подсечки.");
        delayStatusCut.add(label118, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label119, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label119.setToolTipText("Задержка перед парсингом капчи.");
        delayCaptcha.add(label119, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label120 = new JLabel();
        this.$$$loadLabelText$$$(label120, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label120.setToolTipText("Задержка после парсинга и ввода капчи.");
        delayCaptcha.add(label120, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label121, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label121.setToolTipText("Задержка перед определением статуса капчи.");
        delayStatusCaptcha.add(label121, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label122 = new JLabel();
        this.$$$loadLabelText$$$(label122, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label122.setToolTipText("Задержка после определения статуса капчи.");
        delayStatusCaptcha.add(label122, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        this.$$$loadLabelText$$$(label123, ResourceBundle.getBundle("locale").getString("preference.label.before"));
        label123.setToolTipText("Задержка перед запуском задачи по фильтрации лута.");
        delayLooFilter.add(label123, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final JLabel label124 = new JLabel();
        this.$$$loadLabelText$$$(label124, ResourceBundle.getBundle("locale").getString("preference.label.after"));
        label124.setToolTipText("Задержка после фильтрации лута.");
        delayLooFilter.add(label124, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
