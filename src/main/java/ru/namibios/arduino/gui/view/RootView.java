...
public class RootView extends JFrame {
    ...
    public RootView() {
        ...
        payInfo.addActionListener((e) -> ExecUtils.openUri(String.format(UIManager.getString("rootview.menu.premium.payinfo.url"), Application.getInstance().URL_SERVER_HTTP())));
        premium.add(payInfo);
